...
The converter converts WinForms-specific files to Avalonia UI-specific files. 

**UI and business logic**

WinForms *.cs, *.Design.cs files are converted to Avalonia UI *.axaml, *.axaml.cs, and *.cs (View Model)
